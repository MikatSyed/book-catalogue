...
const postOrder = (payload, userId) => __awaiter(void 0, void 0, void 0, function* () {
...
const getALLOrderFromDB = (userId, role) => __awaiter(void 0, void 0, void 0, function* () {
    let result;
...
const getOrderByIdFromDB = (id, userId, role) => __awaiter(void 0, void 0, void 0, function* () {
    let result;
    if (role === client_1.Role.admin) {
    ...
    if (role === client_1.Role.customer) {
        result = yield prisma_1.default.order.findUnique({
            where: Object.assign({ id }, (role === client_1.Role.customer && { userId })),
        });
    }
    if (!result) {
