...
const getAllFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const queryOptions = (0, pick_1.default)(req.query, book_constant_1.queryFields);
    const result = yield book_service_1.BookService.getAllFromDB(filters, queryOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getByCategoryIdFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const queryOptions = (0, pick_1.default)(req.query, book_constant_1.queryFields);
    const result = yield book_service_1.BookService.getByCategoryIdFromDB(categoryId, queryOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
