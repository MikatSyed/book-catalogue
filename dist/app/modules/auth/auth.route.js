...
router.post(
  ...
  (0, validateRequest_1.default)(
    auth_validate_1.AuthValidation.signupZodSchema
  ),
  auth_controller_1.AuthController.createUser
);
router.post(
  '/signin',
  (0, validateRequest_1.default)(auth_validate_1.AuthValidation.loginZodSchema),
  auth_controller_1.AuthController.loginUser
);
router.post(
  '/refresh-token',
  (0, validateRequest_1.default)(
    auth_validate_1.AuthValidation.refreshTokenZodSchema
  ),
